  ...
  return (
    <div className="min-h-screen font-sans text-slate-600 bg-slate-950 selection:bg-purple-500/30 selection:text-purple-200 overflow-x-hidden relative">
      ...
      <section id="home" className="pt-36 pb-24 px-6 relative">
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto animate-fade-in-up">
          {[
        ...
        <div className="max-w-4xl mx-auto px-6 flex justify-center">
          <div className="bg-white p-12 rounded-[2rem] shadow-xl border border-slate-100 text-center max-w-sm w-full relative hover:-translate-y-2 transition-transform duration-500">
            ...
            <ul className="space-y-4 text-left mb-10 pl-4">
              {['Jogo profissional', 'Personalização completa', 'Funciona offline', 'Download ilimitado', 'Sem mensalidade'].map((item, idx) => (
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="border border-slate-200 rounded-2xl overflow-hidden hover:border-purple-200 transition-colors">
                ...
                {faqOpen === idx && (
                  <div className="p-6 pt-0 bg-white text-slate-600 leading-relaxed border-t border-slate-100 animate-fade-in">
                    {item.a}
                  </div>
                )}
              </div>
      ...
      <section className="py-32 relative overflow-hidden bg-slate-900">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 px-6">
          <div className="w-24 h-24 bg-gradient-to-br from-purple-600 to-pink-600 rounded-3xl flex items-center justify-center text-white mx-auto mb-8 shadow-2xl animate-float-medium">
            <Gamepad2 size={64} />
          </div>
