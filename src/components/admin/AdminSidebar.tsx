...
import {
  ...
  MessageSquare, FileText, Settings, LogOut, ShieldAlert, ChevronLeft
} from "lucide-react";
...
const AdminSidebar = () => {
  ...
  // Matriz de permissões baseada no nosso contexto rígido
  const menuItems = [
  ...
  // Filtra o menu dinamicamente e garante que não quebre se userRole for null
    ...
    <aside className="w-64 min-h-screen bg-white border-r border-border p-6 flex flex-col shadow-sm hidden md:flex">
      ...
      <nav className="flex-1 space-y-1.5 overflow-y-auto pr-2 custom-scrollbar">
        {filteredMenu.map((item) => {
          // Lógica estrita para não marcar "Dashboard" como ativo quando estiver em "/admin/clients"
